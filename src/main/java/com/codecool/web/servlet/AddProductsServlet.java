...
public class AddProductsServlet extends AbstractServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try (Connection connection = getConnection(req.getServletContext())) {
            ...
            req.setAttribute("product",dbService.ap(userId));
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try (Connection connection = getConnection(req.getServletContext())) {
            ...
            int supplierId = Integer.parseInt(req.getParameter("user_id"));
            int categoryId = Integer.parseInt(req.getParameter("category_id"));
            int quantityPerUnit = Integer.parseInt(req.getParameter("quantity_per_unit"));
